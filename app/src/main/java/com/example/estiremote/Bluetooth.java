...
public class Bluetooth extends Activity implements OnItemClickListener, OnClickListener {
    int conx=0;
    String msg="";
	...
	public static void wr(byte[] se) {
		
		mConnectedThread.write(se);
...
// Interface de gestion d'une liaison BT RFCOMM
		...
		public void onClick(View v) {
			if(conx==1)
			{
			 Intent intent = new Intent(this,ChoixView.class);
		 this.startActivityForResult(intent,1000);
			}
			else
			{Toast.makeText(getApplicationContext(), "Please connect to device", 0).show();}
